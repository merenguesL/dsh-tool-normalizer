...
function avoidedRoundTrips(category) {
  ...
  if (category === "UNKNOWN_TOOL" || category === "INVALID_ARGS" || category === "RANGE_CLAMP" || category === "CODE_WRAP" || category === "RUN_CODE_DESC" || category === "RUN_CODE_SYNTAX" || category === "INNER_DESC")
    return 1;
  return 0;
}
