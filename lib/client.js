...
var css = `/* Tool-normalizer dashboard. Semantic --dsw-alias-* tokens only; light and
   dark themes resolve through the shared ui-theme sheets. The panel keeps one
   local scale (radii, gaps, borders) on \`.dsh_tn_container\` so every card, chip and
   control shares the same rhythm. Body copy uses the secondary label step so
   12px text stays legible in both themes; the dimmed step is reserved for
   input placeholders and decorative dots. Panels lift with one-step shadows
   and concentric radii (card 16 / inner 12 / control 10 / chip 999). */

.dsh_tn_container {
  --tn-radius-card: 16px;
  --tn-radius-inner: 12px;
  --tn-radius-control: 10px;
  --tn-radius-chip: 999px;
  --tn-gap: 16px;
  --tn-border: var(--dsw-alias-border-l2);
  --tn-border-strong: var(--dsw-alias-border-l3);
...
/* Numbers in metrics and tables must not jitter as they tick. */
.dsh_tn_kpiValue,
.dsh_tn_timeText,
.dsh_tn_rankValue,
.dsh_tn_countBadge,
.dsh_tn_tabCount,
.dsh_tn_guidanceEditorCount,
...
.dsh_tn_hero {
  ...
  border-radius: var(--tn-radius-card);
...
.dsh_tn_btnGhost:hover:not(:disabled) {
  background: var(--dsw-alias-interactive-bg-hover);
...
.dsh_tn_btnDanger:hover:not(:disabled) {
...
.dsh_tn_guidanceEditorSaveBtn:focus-visible,
.dsh_tn_guidanceEditorPreviewSummary:focus-visible {
...
/* The savings figure is a full-width footnote row, so five cards resolve into
   two balanced rows plus one instead of leaving an orphan cell. */
.dsh_tn_kpiCardWide {
  grid-column: 1 / -1;
}
...
.dsh_tn_tabsBar::-webkit-scrollbar {
  display: none;
}
...
.dsh_tn_searchInput:hover {
  border-color: var(--tn-border-strong);
}

.dsh_tn_searchInput::placeholder {
...
.dsh_tn_pillActive,
.dsh_tn_pillActive:hover {
  border-color: color-mix(in srgb, var(--dsw-alias-brand-primary) 45%, transparent);
  background: color-mix(in srgb, var(--dsw-alias-brand-primary) 11%, transparent);
  color: var(--dsw-alias-brand-primary);
}
...
.dsh_tn_pillActive .dsh_tn_countBadge {
...
.dsh_tn_traceCard {
  ...
  border-left-color: var(--tn-border-strong);
  border-radius: var(--tn-radius-inner);
  background: var(--dsw-alias-bg-layer-2);
  overflow: hidden;
...
.dsh_tn_statusPillFail {
  background: color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, transparent);
  color: var(--dsw-alias-state-error-primary);
}

.dsh_tn_statusPillPass {
  background: color-mix(in srgb, var(--dsw-alias-label-primary) 7%, transparent);
  color: var(--dsw-alias-label-secondary);
}
...
.dsh_tn_expandBtnOpen .dsh_tn_chevron {
  transform: rotate(180deg);
}

/* ---- Trace detail (before / after / error) ---- */
...
.dsh_tn_diffLabelBefore {
  color: var(--dsw-alias-state-warn-label);
}

.dsh_tn_diffLabelAfter {
  color: var(--dsw-alias-state-success-primary);
}
...
.dsh_tn_guidanceEditorHeader {
  ...
  border: 1px solid var(--tn-border);
  border-bottom: none;
  border-radius: var(--tn-radius-card) var(--tn-radius-card) 0 0;
  background: var(--dsw-alias-bg-layer-2);
}
...
.dsh_tn_guidanceEditorSaveBtn:hover:not(:disabled) {
  opacity: 0.9;
}
...
.dsh_tn_guidanceEditorBody {
  ...
  border: 1px solid var(--tn-border);
  border-top: none;
  border-radius: 0 0 var(--tn-radius-card) var(--tn-radius-card);
  background: var(--dsw-alias-bg-layer-2);
  box-shadow: var(--dsw-shadow-lv1);
}
...
.dsh_tn_guidanceEditorDirty::before {
  content: "";
  width: 5px;
  height: 5px;
  border-radius: 50%;
...
var NormalizerSection_default = { "container": "dsh_tn_container", "kpiValue": "dsh_tn_kpiValue", "timeText": "dsh_tn_timeText", "rankValue": "dsh_tn_rankValue", "countBadge": "dsh_tn_countBadge", "tabCount": "dsh_tn_tabCount", "guidanceEditorCount": "dsh_tn_guidanceEditorCount", "guidanceEditorTextarea": "dsh_tn_guidanceEditorTextarea", "guidanceEditorPreviewCode": "dsh_tn_guidanceEditorPreviewCode", "codeBox": "dsh_tn_codeBox", "hero": "dsh_tn_hero", "heroMain": "dsh_tn_heroMain", "heroMark": "dsh_tn_heroMark", "titleGroup": "dsh_tn_titleGroup", "titleRow": "dsh_tn_titleRow", "title": "dsh_tn_title", "versionBadge": "dsh_tn_versionBadge", "repoLinks": "dsh_tn_repoLinks", "repoLink": "dsh_tn_repoLink", "subtitle": "dsh_tn_subtitle", "headerActions": "dsh_tn_headerActions", "btnIcon": "dsh_tn_btnIcon", "btnGhost": "dsh_tn_btnGhost", "btnDanger": "dsh_tn_btnDanger", "pill": "dsh_tn_pill", "tabItem": "dsh_tn_tabItem", "expandBtn": "dsh_tn_expandBtn", "copyBtn": "dsh_tn_copyBtn", "searchInput": "dsh_tn_searchInput", "guidanceEditorSaveBtn": "dsh_tn_guidanceEditorSaveBtn", "guidanceEditorPreviewSummary": "dsh_tn_guidanceEditorPreviewSummary", "kpiGrid": "dsh_tn_kpiGrid", "kpiCard": "dsh_tn_kpiCard", "kpiCardWide": "dsh_tn_kpiCardWide", "kpiHead": "dsh_tn_kpiHead", "kpiIcon": "dsh_tn_kpiIcon", "kpiIconAccent": "dsh_tn_kpiIconAccent", "kpiIconSuccess": "dsh_tn_kpiIconSuccess", "kpiIconDanger": "dsh_tn_kpiIconDanger", "kpiIconWarn": "dsh_tn_kpiIconWarn", "kpiTitle": "dsh_tn_kpiTitle", "estimateBadge": "dsh_tn_estimateBadge", "kpiValueAccent": "dsh_tn_kpiValueAccent", "kpiValueSuccess": "dsh_tn_kpiValueSuccess", "kpiValueDanger": "dsh_tn_kpiValueDanger", "kpiDesc": "dsh_tn_kpiDesc", "kpiMeter": "dsh_tn_kpiMeter", "kpiMeterFill": "dsh_tn_kpiMeterFill", "tabsBar": "dsh_tn_tabsBar", "tabActive": "dsh_tn_tabActive", "livePane": "dsh_tn_livePane", "toolbar": "dsh_tn_toolbar", "searchWrap": "dsh_tn_searchWrap", "searchIcon": "dsh_tn_searchIcon", "pills": "dsh_tn_pills", "pillActive": "dsh_tn_pillActive", "traceList": "dsh_tn_traceList", "traceCard": "dsh_tn_traceCard", "traceCardOk": "dsh_tn_traceCardOk", "traceCardFail": "dsh_tn_traceCardFail", "traceHeader": "dsh_tn_traceHeader", "traceMeta": "dsh_tn_traceMeta", "traceSide": "dsh_tn_traceSide", "badgeTool": "dsh_tn_badgeTool", "badgeCategory": "dsh_tn_badgeCategory", "statusPill": "dsh_tn_statusPill", "statusPillOk": "dsh_tn_statusPillOk", "statusPillFail": "dsh_tn_statusPillFail", "statusPillPass": "dsh_tn_statusPillPass", "chevron": "dsh_tn_chevron", "expandBtnOpen": "dsh_tn_expandBtnOpen", "diffGrid": "dsh_tn_diffGrid", "changeSummary": "dsh_tn_changeSummary", "changeSummaryLabel": "dsh_tn_changeSummaryLabel", "diffColumns": "dsh_tn_diffColumns", "diffBlock": "dsh_tn_diffBlock", "errorBlock": "dsh_tn_errorBlock", "diffLabelRow": "dsh_tn_diffLabelRow", "diffLabel": "dsh_tn_diffLabel", "diffLabelBefore": "dsh_tn_diffLabelBefore", "diffLabelAfter": "dsh_tn_diffLabelAfter", "codeBefore": "dsh_tn_codeBefore", "codeAfter": "dsh_tn_codeAfter", "codeError": "dsh_tn_codeError", "jsonKey": "dsh_tn_jsonKey", "jsonString": "dsh_tn_jsonString", "jsonNumber": "dsh_tn_jsonNumber", "jsonBool": "dsh_tn_jsonBool", "jsonNull": "dsh_tn_jsonNull", "jsonEllipsis": "dsh_tn_jsonEllipsis", "emptyState": "dsh_tn_emptyState", "emptyMark": "dsh_tn_emptyMark", "emptyTitle": "dsh_tn_emptyTitle", "emptyDesc": "dsh_tn_emptyDesc", "analyticsPane": "dsh_tn_analyticsPane", "healthCard": "dsh_tn_healthCard", "healthCardMuted": "dsh_tn_healthCardMuted", "healthMark": "dsh_tn_healthMark", "healthTitle": "dsh_tn_healthTitle", "healthDesc": "dsh_tn_healthDesc", "rankGrid": "dsh_tn_rankGrid", "rankCard": "dsh_tn_rankCard", "cardTitle": "dsh_tn_cardTitle", "rankEmpty": "dsh_tn_rankEmpty", "rankList": "dsh_tn_rankList", "rankItem": "dsh_tn_rankItem", "rankLabelRow": "dsh_tn_rankLabelRow", "rankName": "dsh_tn_rankName", "barBg": "dsh_tn_barBg", "barFillAccent": "dsh_tn_barFillAccent", "barFillSuccess": "dsh_tn_barFillSuccess", "rulesPane": "dsh_tn_rulesPane", "rulesGrid": "dsh_tn_rulesGrid", "ruleCard": "dsh_tn_ruleCard", "ruleHead": "dsh_tn_ruleHead", "ruleTitle": "dsh_tn_ruleTitle", "ruleTag": "dsh_tn_ruleTag", "ruleDesc": "dsh_tn_ruleDesc", "guidanceEditor": "dsh_tn_guidanceEditor", "guidanceEditorHeader": "dsh_tn_guidanceEditorHeader", "guidanceEditorTitleGroup": "dsh_tn_guidanceEditorTitleGroup", "guidanceEditorIcon": "dsh_tn_guidanceEditorIcon", "guidanceEditorTitle": "dsh_tn_guidanceEditorTitle", "guidanceEditorDesc": "dsh_tn_guidanceEditorDesc", "guidanceEditorActions": "dsh_tn_guidanceEditorActions", "guidanceEditorMsg": "dsh_tn_guidanceEditorMsg", "guidanceEditorMsgOk": "dsh_tn_guidanceEditorMsgOk", "guidanceEditorMsgError": "dsh_tn_guidanceEditorMsgError", "guidanceEditorBody": "dsh_tn_guidanceEditorBody", "guidanceEditorFooter": "dsh_tn_guidanceEditorFooter", "guidanceEditorDirty": "dsh_tn_guidanceEditorDirty", "guidanceEditorLoading": "dsh_tn_guidanceEditorLoading", "guidanceEditorPreview": "dsh_tn_guidanceEditorPreview", "guidancePreviewLine": "dsh_tn_guidancePreviewLine", "guidancePreviewHeading": "dsh_tn_guidancePreviewHeading", "guidancePreviewListItem": "dsh_tn_guidancePreviewListItem" };
...
function RefreshIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(StrokeIcon, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M13.5 8a5.5 5.5 0 1 1-1.8-4.1" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M13.6 1.9v3.2h-3.2" })
  ] });
}
function DownloadIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(StrokeIcon, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M8 1.8v8.4" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M4.8 7.2 8 10.4l3.2-3.2" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M2.2 12.6h11.6" })
  ] });
}
function TrashIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(StrokeIcon, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M2.4 4.2h11.2" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M6.2 4.2V2.6h3.6v1.6" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M3.9 4.2 4.6 13a.8.8 0 0 0 .8.7h5.2a.8.8 0 0 0 .8-.7l.7-8.8" })
  ] });
}
function ChevronIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(StrokeIcon, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M4 6.2 8 10.2l4-4" }) });
}
function CopyIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(StrokeIcon, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("rect", { x: "5.6", y: "5.6", width: "8.2", height: "8.2", rx: "1.8" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M10.4 5.6V4a1.8 1.8 0 0 0-1.8-1.8H4a1.8 1.8 0 0 0-1.8 1.8v4.6A1.8 1.8 0 0 0 4 10.4h1.6" })
  ] });
}
function CheckIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(StrokeIcon, { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M3.2 8.4 6.4 11.6l6.4-7.2" }) });
}
function CodeIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(StrokeIcon, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M6 2.4 2.4 8 6 13.6" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M10 2.4 13.6 8 10 13.6" })
  ] });
}
...
function statusPillTone(record) {
  if (record.status === "failed") return NormalizerSection_default.statusPillFail;
  if (record.wasHealed && record.status === "success")
    return NormalizerSection_default.statusPillOk;
  return NormalizerSection_default.statusPillPass;
}
function idleState() {
  return {
    status: "idle",
...
function NormalizerSection(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.container, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.headerActions, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: NormalizerSection_default.btnIcon, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(RefreshIcon, {}) }),
              t("refresh")
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            ...
            disabled: !hasData,
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: NormalizerSection_default.btnIcon, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DownloadIcon, {}) }),
              t("export")
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            ...
            disabled: !hasData,
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: NormalizerSection_default.btnIcon, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TrashIcon, {}) }),
              t("clear")
            ]
          }
        )
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: NormalizerSection_default.kpiGrid, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: `${NormalizerSection_default.kpiCard} ${NormalizerSection_default.kpiCardWide}`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: NormalizerSection_default.kpiHead, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "span",
            {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.traceHeader, children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.traceMeta, children: [
                  ...
                  record.category !== "PASSTHROUGH" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: NormalizerSection_default.badgeCategory, children: formatCategory(record.category) })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.traceSide, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                    "span",
                    {
                      className: `${NormalizerSection_default.statusPill} ${statusPillTone(record)}`,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
                    ...
                    {
                      type: "button",
                      className: `${NormalizerSection_default.expandBtn} ${isExpanded ? NormalizerSection_default.expandBtnOpen : ""}`,
                      "aria-expanded": isExpanded,
                      onClick: () => toggleExpand(record.id),
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: NormalizerSection_default.chevron, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ChevronIcon, {}) }),
              ...
              isExpanded && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.diffGrid, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.diffColumns, children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.diffLabelRow, children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                        "button",
                        {
                          ...
                          children: copiedKey === `${record.id}:before` ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CheckIcon, {}) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CopyIcon, {})
                        }
                      )
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.diffLabelRow, children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                        "button",
                        {
                          ...
                          children: copiedKey === `${record.id}:after` ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CheckIcon, {}) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CopyIcon, {})
                        }
                      )
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                      JsonBlock,
                      {
                        code: record.normalizedArgsPreview || t("afterUnchanged"),
                ...
                record.errorMessage && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.errorBlock, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: NormalizerSection_default.diffLabelRow, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                    "span",
                    {
                      className: `${NormalizerSection_default.diffLabel} ${NormalizerSection_default.diffLabelBefore}`,
    ...
    state.activeTab === "rules" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: NormalizerSection_default.rulesPane, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: NormalizerSection_default.guidanceEditor, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.guidanceEditorBody, children: [
          ...
          guidanceLoading ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: NormalizerSection_default.guidanceEditorLoading, children: t("noData") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "textarea",
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: NormalizerSection_default.guidanceEditorFooter, children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: NormalizerSection_default.guidanceEditorCount, children: [
                guidanceText.split("\n").length,
                " ",
                t("guidanceLines"),
                " \xB7",
              ...
              guidanceDirty && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: NormalizerSection_default.guidanceEditorDirty, children: t("guidanceDirty") })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("details", { className: NormalizerSection_default.guidanceEditorPreview, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: NormalizerSection_default.guidanceEditorPreviewCode, children: (guidanceText || t("guidanceEmpty")).split("\n").map((line, i) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                  "div",
                  {
                    className: NormalizerSection_default[cls] || NormalizerSection_default.guidancePreviewLine,
                    children: content || "\xA0"
                  },
                  i
                );
              }) })
...
var ToolNormalizerTracker = class _ToolNormalizerTracker {
  ...
  failuresByTool = /* @__PURE__ */ Object.create(null);
  failuresByCategory = /* @__PURE__ */ Object.create(
    null
  );
  records = [];
  ...
  record(record) {
    ...
    if (record.status === "failed") {
      this.failuresByTool[record.toolName] = (this.failuresByTool[record.toolName] ?? 0) + 1;
      this.failuresByCategory[record.category] = (this.failuresByCategory[record.category] ?? 0) + 1;
    }
    if (record.status === "success" && record.wasHealed) {
  ...
  healingRate() {
    ...
    return totalHealAttempts > 0 ? Math.round(this.healedSuccess / totalHealAttempts * 1e3) / 10 : 0;
  }
  /**
  ...
  reset() {
    ...
    this.failuresByTool = /* @__PURE__ */ Object.create(null);
    this.failuresByCategory = /* @__PURE__ */ Object.create(null);
    this.records = [];
  }
};
