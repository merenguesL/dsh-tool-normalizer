...
export interface NormalizerSectionProps
  extends Partial<NormalizerSectionInjected> {}

/** Public repository links rendered as quiet icon buttons beside the version. */
...
export function NormalizerSection(
  props: NormalizerSectionProps,
): React.ReactElement {
  ...
  const copyText = (key: string, text: string): void => {
    void navigator.clipboard
      ...
      .catch(() => {
        /* clipboard unavailable — the button simply stays inert */
      });
  };
    ...
    <div className={styles.container}>
      ...
      <section className={styles.kpiGrid}>
        ...
        <div className={styles.kpiCard}>
          ...
          >
            {stats.healedFailed + stats.passThroughFailed}
          </span>
                  ...
                  {(
                    [
                      ...
                      [
                        "failed",
                        t("filterFailed"),
                        stats.recentRecords.filter((r) => r.status === "failed")
                          .length,
                      ],
                      [
                        "direct",
                          ...
                          <div className={styles.diffGrid}>
                            {record.normalizationSummary && (
                              <div className={styles.changeSummary}>
                                <span className={styles.changeSummaryLabel}>
                                  {t("changeSummary")}
                                </span>
